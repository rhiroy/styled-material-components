  ...
  render() {
    return (
      <div className={this.props.className}>
        ...
        />
        <TextFieldWithBottomMargin helperText={'persistent helper text'} helperTextPersistent />
        ...
        />
        <TextFieldWithBottomMargin hintText={'Focus disabled'} focusDisabled />
        ...
        />
        <TextFieldWithBottomMargin floatingLabelText={'A required field'} required />
        ...
        <h2>Text areas</h2>
        <TextFieldWithBottomMargin textarea floatingLabelText="Text area with 1 row" />
        <TextFieldWithBottomMargin textarea floatingLabelText="Text area with two rows" rows={2} />
        <TextFieldWithBottomMargin textarea multiline floatingLabelText="Multiline text area" />
        <TextFieldWithBottomMargin
          textarea
        ...
        <TextFieldWithBottomMargin floatingLabelText="Dropdown Menu" options={'invalid option'} />
      </div>
    );
  }
}
