...
const CardsPage = ({ className }) => (
  <div className={className}>
    ...
    <DemoCard>
      <CardPrimary title="Title" subheader="Subhead" />
      <CardSupportingText>
        Praesent commodo cursus magna, vel scelerisque nisl consectetur et. Integer posuere erat a
        ante venenatis dapibus posuere velit aliquet. Donec id elit non mi porta gravida at eget
        metus. Maecenas sed diam eget risus varius blandit sit amet non magna.
      </CardSupportingText>
      <CardActions>
        <Button compact>Action 1</Button>
        <Button compact>Action 2</Button>
